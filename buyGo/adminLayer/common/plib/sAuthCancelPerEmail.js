/****************************************************************************************************
module명: sAuthCancelPerEmail.js
creator: 안상현
date: 2022.9.15
version 1.0
설명: 기 발번된 인증코드+이메일별 무효처리하는 모듈
...
let sAuthCancelPerEmail={
    authCancelPerEmail: async function(request, response)
    {
        if(request.body!=undefined&&request.body!=null)
        {
            ...
            let tmpStr   =" UPDATE "+mydb.database+".TB_P00_EMAIL_AUTH_LOG a \n";
...
module.exports=sAuthCancelPerEmail;