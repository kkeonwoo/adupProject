/****************************************************************************************************
module명: cSettlementManagementSuper.js
creator: 윤희상
date: 2022.04.12
version 1.0
설명: SUPER 페이지에서 정산관리 화면용 js
...
function drawOrderList(preturnValue, pGetGlobalListCount, pGetCurrentPage){
    ...
    if(preturnValue.errorcode == "PFERR_CONF_0000"){
        ...
        totInnerHTML+=`	<td rowspan="3"><span class="comma">${(returnTotal[0].ORDER_CNT).toLocaleString('ko-KR')}</span> 건</td> \n`;
