...
function drawOrderList(preturnValue, pGetGlobalListCount, pGetCurrentPage){
    ...
    if(preturnValue.errorcode == "PFERR_CONF_0000"){
        ...
        // //2022.04.01 윤희상 테스트를 위해 조회시에 엑셀이 다운로드 되게끔 넣음
        // var myTestXML = new cJsonToXMLToExcel(preturnValue.returnvalue);
        // myTestXML.downLoad("sheet Name Test","FIle_Name_Test");
