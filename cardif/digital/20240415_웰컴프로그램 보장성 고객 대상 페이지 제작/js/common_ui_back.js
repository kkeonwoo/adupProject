var common_ui = {
    ...
    footer_tab:function(){
        $(".footCenter .tab").click(function(){
            ...
            $(this).attr("title", "현재메뉴 선택됨").siblings().removeAttr("title");
            //$(this).children("button").attr("title", "");

//            if(!$(this).hasClass("on")){
  //               $(this).children("button").removeAttr("title");
    //            }
        });
    },
    ...
    networkGo:function() {
        ...
        $wrap.find('a.btn_nt').on('click', function() {
