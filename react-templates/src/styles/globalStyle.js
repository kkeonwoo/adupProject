...
import NotoKrLight from '../font/notokr-light.woff2';
import NotoKrRegular from '../font/notokr-regular.woff2';
import NotoKrMedium from '../font/notokr-medium.woff2';
import NotoKrBold from '../font/notokr-bold.woff2';
...
const GlobalStyle = createGlobalStyle`
  ...
  @font-face {
    ...
    font-weight: 100;
    src: url(${NotoKrLight}) format('woff2'),
  }
  @font-face {
      font-family: 'Noto Sans KR';
      font-weight: 400;
      src: url(${NotoKrRegular}) format('woff2'),
  }
  @font-face {
      font-family: 'Noto Sans KR';
      font-weight: 500;
      src: url(${NotoKrMedium}) format('woff2'),
  }
  @font-face {
      font-family: 'Noto Sans KR';
      font-weight: 700;
      src: url(${NotoKrBold}) format('woff2'),
  }
  
  *{padding:0;margin:0;-webkit-text-size-adjust: none; -moz-text-size-adjust: none; -ms-text-size-adjust: none;box-sizing: border-box;-ms-box-sizing: border-box;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;font-family: 'Noto Sans KR','맑은 고딕','sans-serif';font-size:16px;font-weight: 400; line-height: 1; color:#000000;}
  ...
  .d_flex {display:flex;}
  .gap_px_10 { gap: 10px !important;}

  .btn_wrap { display: flex; flex-direction:row; flex-wrap:wrap; justify-content: center; gap:20px; margin-top:40px;}
`;
